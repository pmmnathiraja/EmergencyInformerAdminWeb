...
uploadFoodAndImage(Food food, bool isUpdating, File localFile,
    Function foodUploaded, String userNIC) async {
  if (localFile != null) {
    ...
    final StorageReference firebaseStorageRef = FirebaseStorage.instance
        .ref()
        .child('Medical_Reports/$userNIC/$uuid$fileExtension');
...
_uploadFood(Food food, bool isUpdating, Function foodUploaded, String userNIC,
